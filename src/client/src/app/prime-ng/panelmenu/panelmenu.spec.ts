...
describe('PanelMenu', () => {
    ...
    it('should change item url target item and listLabel', () => {
      panelmenu.model = [
        {
            label: 'File',
            icon: 'Primeng ROCKS!',
    ...
    it('should change child url target icon disabled and listLabel', () => {
      panelmenu.model = [
        {
            label: 'File',
            icon: 'Primeng ROCKS!',
    ...
    it('should show columns and call toggle', () => {
      panelmenu.model = [
        {
            label: 'File',
            icon: 'pi pi-pw pi-file',
